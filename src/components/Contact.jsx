    ...
    <section id="contact" className="deepa-bg-dark section-padding relative overflow-hidden"
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto">
        <motion.div initial={{opacity:0,y:30}} animate={inView?{opacity:1,y:0}:{}} transition={{duration:0.8}} className="text-center mb-14">
          <p className="font-sans text-[14px] tracking-[0.6em] uppercase text-yellow-600/75 mb-4">Get In Touch</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <motion.div initial={{opacity:0,x:-40}} animate={inView?{opacity:1,x:0}:{}} transition={{duration:0.8,delay:0.2}} className="space-y-5">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={label} className="flex items-start gap-4 group">
                    ...
                    <div>
                      <p className="font-sans text-[13px] tracking-[0.28em] uppercase text-yellow-700/70 mb-0.5">{label}</p>
                      {href
            ...
            <a href="https://wa.me/917993393339?text=Hi%20Deepa%20Bridal%20Studio!%20I'd%20like%20to%20book%20a%20bridal%20makeup%20consultation."
              ...
              <p className="font-sans text-[13px] tracking-[0.4em] uppercase text-green-400/75 mb-2">Book via WhatsApp</p>
            ...
            <a href="tel:+917993393339"
              ...
              <p className="font-sans text-[13px] tracking-[0.4em] uppercase text-yellow-700/75 mb-2">Call Now</p>
          ...
          <motion.div initial={{opacity:0,x:40}} animate={inView?{opacity:1,x:0}:{}} transition={{duration:0.8,delay:0.3}}
            ...
            <div className="p-4 sm:p-5">
              <p className="font-sans text-[13px] tracking-[0.32em] uppercase text-yellow-700/70 mb-3">Find Us on Google Maps</p>
              ...
              <a href="https://maps.app.goo.gl/DEtJuy7pCm8RWVfB7" target="_blank" rel="noopener noreferrer"
                className="touch-target inline-flex items-center gap-2 mt-3 px-4 py-2 border border-yellow-800/30 hover:border-yellow-600 transition-all duration-300 font-sans text-[13px] tracking-[0.25em] uppercase text-yellow-500/80 hover:text-yellow-400">
                <MapPin size={12} />
