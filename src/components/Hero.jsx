    ...
    <section id="home"
      ...
      <div className="relative z-[3] flex flex-col items-center text-center w-full px-6 max-w-5xl gap-y-5 sm:gap-y-6">
        ...
        <motion.h1 initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.9,delay:0.6}}
          className="font-display hero-heading text-5xl md:text-7xl lg:text-8xl font-semibold tracking-[0.02em] sm:tracking-[0.08em] uppercase gold-text -mt-2 sm:-mt-3">
          Deepa Bridal Studio
        </motion.h1>
        ...
        <motion.p initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:1,delay:1.2}}
          className="font-display hero-sub text-4xl sm:text-5xl md:text-6xl gold-text italic leading-relaxed mb-4 sm:mb-6"
          style={{textShadow:'0 2px 12px rgba(0,0,0,0.6)'}}>
          Signature bridal artistry<br />by Deepa
        </motion.p>
        ...
        <motion.a href="tel:+917993393339" initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.8,delay:1.6}}
          className="touch-target font-display text-3xl sm:text-4xl md:text-5xl gold-text hover:opacity-80 transition-opacity mb-4 sm:mb-6"
