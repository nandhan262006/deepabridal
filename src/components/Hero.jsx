  ...
  return (
    <section id="home" className="deepa-bg relative min-h-[60vh] sm:min-h-[85vh] lg:min-h-screen flex items-center justify-center pt-24 sm:pt-28 overflow-hidden"
      ...
      <div className="relative z-[3] text-center px-6 max-w-5xl mx-auto">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:0.2}}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <span className="font-sans text-[13px] sm:text-[14px] tracking-[0.4em] sm:tracking-[0.5em] uppercase text-yellow-500/80">Est. in Nellore</span>
            <Sparkles size={10} className="text-yellow-500 hidden sm:block" />
          </div>
        ...
        <motion.p initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.8,delay:0.8}}
          className="font-sans text-[14px] sm:text-xs md:text-sm tracking-[0.4em] sm:tracking-[0.6em] uppercase text-yellow-400/75 mb-3 sm:mb-4">
        ...
        <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.8,delay:1.0}}
          ...
          {["Hair","Skin","Makeup","Nails"].map((s,i)=>(
            <span key={s} className="flex items-center gap-2 sm:gap-3">
              <span className="font-sans text-[14px] sm:text-xs tracking-[0.18em] sm:tracking-[0.25em] uppercase text-yellow-300/85">{s}</span>
              {i<3&&<span className="text-yellow-700/50 text-[14px] sm:text-xs">|</span>}
            </span>
          ))}
          <div className="h-px w-6 sm:w-10 bg-yellow-700/50" />
        </motion.div>
        ...
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:1.4}}
          ...
          <a href="#contact"
            className="touch-target w-full sm:w-auto flex items-center justify-center px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-yellow-700 via-yellow-400 to-yellow-700 text-green-950 font-sans text-[15px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] uppercase font-semibold hover:shadow-lg hover:shadow-yellow-500/25 transition-all duration-300 hover:scale-105"
            aria-label="Book your bridal makeup appointment at Deepa Bridal Studio Nellore">
            Book Your Bridal Look
          </a>
          <a href="#gallery"
            className="touch-target w-full sm:w-auto flex items-center justify-center px-8 sm:px-10 py-3 sm:py-4 border border-yellow-600/50 text-yellow-300/85 font-sans text-[15px] sm:text-xs tracking-[0.25em] sm:tracking-[0.3em] uppercase hover:border-yellow-400 hover:bg-yellow-500/5 transition-all duration-300"
      ...
      <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{delay:2.2}}
        ...
        <span className="font-sans text-[12px] sm:text-[13px] tracking-[0.35em] sm:tracking-[0.4em] uppercase text-yellow-600/60">Scroll</span>
